:project-name: miq-RedHat-RHEV
:project-repo: https://github.com/rhtconsulting/miq-RedHat-RHEV
:project-zip: https://github.com/rhtconsulting/miq-RedHat-RHEV/archive/master.zip
