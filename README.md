...
| Carsten Clasohm | clasohm@redhat.com |
...
```
PROJECT_NAME="miq-RedHat-RHEV"
PROJECT_ZIP="https://github.com/rhtconsulting/miq-RedHat-RHEV/archive/master.zip"
cd /tmp
